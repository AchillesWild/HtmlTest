    ...
    function getTheGoodsSupplierType() {
        var goodsSupplierTypeArray = getGoodsSupplierType();
        $.each(goodsSupplierTypeArray, function(index, value){
            if(index == 0){
               $("#supplierType").append("<option value='' selected></option>");
            }
            $("#supplierType").append("<option value='" +index+ "'>"+value+"</option>");
        });
    }
